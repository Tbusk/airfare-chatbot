...
class Flight:
    def __init__(self, flight_number: int, departure_location: Location, arrival_location: Location, departure_time: datetime, estimated_arrival_time: datetime, aircraft: Aircraft):
